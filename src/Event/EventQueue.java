 ...
 *
 * Denna klass använder en PriorityQueue för att hålla reda på och ordna händelser baserat på när de ska inträffa.
 * Händelser med tidigare tidpunkter kommer att hanteras före de som inträffar senare, vilket möjliggör en sekventiell
 * simulering av händelseförloppet.
 *
 * Klassen tillhandahåller metoder för att lägga till, hämta och ta bort händelser från kön.
 * 
...
public class EventQueue {
     ...
     *
     * Prioritetsordningen baseras på händelsernas tidpunkter, där händelser som ska inträffa tidigare
     * ges högre prioritet.
     */
    public EventQueue() {
