 ...
 *
 * Varje specifik händelse ska ärva från denna klass och implementera de abstrakta metoderna
 * för att definiera händelsens beteende, tidpunkt, namn och associerad kund.
 *
...
abstract public class Event {
     ...
     *
     * @return Den kund som är associerad med händelsen, eller null om ingen kund är associerad.
     */
